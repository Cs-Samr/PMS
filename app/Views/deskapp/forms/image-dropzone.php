            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box height-100-p">
                    ...
                    <div class="alert alert-success" style="text-align: center;">
                        ...
                        <form id="level4Form"  action="<?= base_url('deskapp/forms/saveForm'); ?>" method="post">
			  ...
			  <input name="statepro" type="hidden" value = "منتهي" >
                            ...
                            <div class="row">
                                <div class="col">
									...
									href = "http://localhost/MS/deskapp/forms/imagecropper?id_project=<?= $_GET['id_project'] ?>" >السابق</a>
                                </div>
                                <div class="col">
                                    <button class="btn btn-outline-success btn-block"  name="submit_form" type="submit">حفظ المرحلة

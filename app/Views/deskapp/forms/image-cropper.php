            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box height-100-p">
                    ...
                    <div class="alert alert-success" style="text-align: center;">
                        ...
                        <form id="level3Form"  action="<?= base_url('deskapp/forms/saveForm'); ?>" method="post">
                        <input name="title" type="hidden" value="جمع متطلبات المشروع" required>
                            ...
                            <div class="row">
                                <div class="col">
									...
									href = "http://localhost/MS/deskapp/forms/html5editor?id_project=<?= $_GET['id_project'] ?>" >السابق</a>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
									...
									href = "http://localhost/MS/deskapp/forms/imagedropzone?id_project=<?= $_GET['id_project'] ?>" >التالي</a>
                                </div>
                            </div>
                        </form>
                    </div>
